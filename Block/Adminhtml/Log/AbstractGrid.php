...
abstract class AbstractGrid extends \M2E\Temu\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    {
        return [
            \M2E\Temu\Model\Log\AbstractModel::TYPE_INFO => (string)__('Info'),
            \M2E\Temu\Model\Log\AbstractModel::TYPE_SUCCESS => (string)__('Success'),
            \M2E\Temu\Model\Log\AbstractModel::TYPE_WARNING => (string)__('Warning'),
            \M2E\Temu\Model\Log\AbstractModel::TYPE_ERROR => (string)__('Error'),
        ];
    }
    ...
    public function callbackColumnType($value, $row, $column, $isExport)
    {
        switch ($row->getData('type')) {
            case \M2E\Temu\Model\Log\AbstractModel::TYPE_SUCCESS:
                $value = '<span style="color: green;">' . $value . '</span>';
                break;

            case \M2E\Temu\Model\Log\AbstractModel::TYPE_WARNING:
                $value = '<span style="color: orange; font-weight: bold;">' . $value . '</span>';
                break;

            case \M2E\Temu\Model\Synchronization\Log::TYPE_FATAL_ERROR:
            case \M2E\Temu\Model\Log\AbstractModel::TYPE_ERROR:
...
HTML;
        ...
        if (
            ...
            $colorMap = [
                \M2E\Temu\Model\Log\AbstractModel::TYPE_INFO => 'gray',
                \M2E\Temu\Model\Log\AbstractModel::TYPE_SUCCESS => 'green',
                \M2E\Temu\Model\Log\AbstractModel::TYPE_WARNING => 'orange',
                \M2E\Temu\Model\Log\AbstractModel::TYPE_ERROR => 'red',
            ];
    ...
    protected function _toHtml()
    {
        ...
        $this->js->addRequireJs(['l' => 'Temu/Log'], "window.LogObj = new Log();");
