...
namespace M2E\Temu\Block\Adminhtml\Listing\Wizard\Category\Add;

class Tree extends \M2E\Temu\Block\Adminhtml\Listing\Category\Tree
{
    ...
    private \M2E\Temu\Helper\Module\Database\Structure $databaseHelper;
    ...
    public function __construct(
        ...
        \M2E\Temu\Block\Adminhtml\Magento\Context\Template $blockContext,
    ...
    {
        return $this->currentNode->getId() ?? null;
    }
    ...
    protected function loadProductsCount($collection)
    {
        ...
        $excludeProductsSelect = $collection->getConnection()->select()->from(
            ...
            new \Zend_Db_Expr('DISTINCT `magento_product_id`'),
        );
