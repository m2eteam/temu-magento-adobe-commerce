...
{
    private \M2E\Temu\Model\Product\Action\Type\Delete\Request $request;
    ...
    {
        return \M2E\Temu\Model\Product\Action\Async\DefinitionsCollection::ACTION_DELETE;
    }
    ...
    protected function getCommand(): \M2E\Core\Model\Connector\CommandProcessingInterface
    {
        ...
        return new \M2E\Temu\Model\Channel\Connector\Product\StopCommand(
    ...
    private function getRequest(): \M2E\Temu\Model\Product\Action\Type\Delete\Request
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
