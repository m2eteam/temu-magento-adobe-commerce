...
{
    private \M2E\Temu\Model\Product\Action\Type\Stop\Request $request;
    ...
    {
        return \M2E\Temu\Model\Product\Action\Async\DefinitionsCollection::ACTION_STOP;
    }
    ...
    private function getRequest(): \M2E\Temu\Model\Product\Action\Type\Stop\Request
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
