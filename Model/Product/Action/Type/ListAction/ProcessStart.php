...
{
    private \M2E\Temu\Model\Product\Action\Type\ListAction\Request $request;
    ...
    {
        return \M2E\Temu\Model\Product\Action\Async\DefinitionsCollection::ACTION_LIST;
    }
    ...
    protected function getCommand(): \M2E\Core\Model\Connector\CommandProcessingInterface
    {
        ...
        return new \M2E\Temu\Model\Channel\Connector\Product\ListCommand(
    ...
    private function getRequest(): \M2E\Temu\Model\Product\Action\Type\ListAction\Request
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
